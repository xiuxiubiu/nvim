...
api.nvim_set_keymap('n', '\'b',
                    '<cmd> lua require"dap".toggle_breakpoint()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'cl',
...
api.nvim_set_keymap('n', '\'rn', '<cmd> lua vim.lsp.buf.rename()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'ca', '<cmd> lua vim.lsp.buf.code_action()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'g', '<cmd> lua vim.lsp.buf.definition()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'rf', '<cmd> lua vim.lsp.buf.references()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'ei', '<cmd> lua vim.diagnostic.open_float()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'el', '<cmd> lua vim.diagnostic.setloclist()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'ep',
                    '<cmd> lua vim.diagnostic.goto_prev()<cr><cmd> lua vim.diagnostic.open_float()<cr>',
                    {nowait = true})
api.nvim_set_keymap('n', '\'en',
...
api.nvim_set_keymap('n', 'gi',
                    '<cmd>lua require"gitsigns".blame_line({full = true})<cr>',
                    {nowait = true})

-- replace
api.nvim_set_keymap('n', 'Rr',
