return {
    ...
    dependencies = {
        ...
        'hrsh7th/cmp-path', 'hrsh7th/cmp-cmdline', -- For vsnip users.
        'hrsh7th/cmp-vsnip', 'hrsh7th/vim-vsnip', -- For luasnip users.
        'L3MON4D3/LuaSnip', 'saadparwaiz1/cmp_luasnip', -- For ultisnips users.
    ...
    config = function()
        ...
        cmp.setup({
            ...
            sorting = {
                comparators = {
                    cmp.config.compare.length, cmp.config.compare.offset,
